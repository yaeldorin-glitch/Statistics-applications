...
עכשיו אפשר להשוות ישירות בין שתי הגישות. הפוסטריורי מוצג בשלושה פאנלים נפרדים, אחד לכל פרמטר, חיתוך, שיפוע וסיגמא: בכל פאנל ציר ה-X הוא הערך האפשרי של הפרמטר וציר ה-Y הוא צפיפות ההסתברות, עם עקומה שמראה כמה סביר כל ערך, קו שמסמן את אומדן הנקודה, ותחום מוצלל שמסמן את רווח האמון.
